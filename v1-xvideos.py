...
class XVideo:
    download_video_to = 'videos/{}/{}'
    #download_thumb_to = 'thumbs/{}/{}'
    ...
    def __init__(s, id, link, title, thumb, resolution, views, uploader, duration):
        ...
        s.video = s.download_video_to.format(id, name)
        s.video_cached = os.path.isdir(s.video)
    ...
    def download(s):
        ...
        if not os.path.isdir(s.video):
            os.makedirs(os.path.dirname(s.video))
